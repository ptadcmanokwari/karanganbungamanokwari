...
<!-- The Modal -->
<div class="modal fade" id="addNewTestimonial" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    tabindex="-1" aria-labelledby="addNewTestimonialLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <form action="<?= base_url('admin/save_testimonials') ?>" class="dropzone" id="sliderImage">
                        </form>
                    </div>
