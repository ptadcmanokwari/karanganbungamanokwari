                    ...
                    <div class="white_box_tittle list_header">
                        ...
                        <div class="box_right d-flex lms_block">
                            <div class="add_button ms-2">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#addGalleryCroping"
                                    class="btn_1">Tambah Galeri Baru</a>
                            </div>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <div class="form-group">
                        <div id="errormsgkategorigaleri" class="alert alert-danger alert-dismissible fade show"
                            role="alert" style="display:none;">
                            <strong>Nama Kategori Galeri Wajib Diisi</strong>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <label for="kategoriCroping">Nama/Kategori Galeri</label>
                        <input type="text" id="kategoriCroping" name="kategoriCroping" class="form-control"
...
$(document).ready(function() {
        ...
        columns: [{
            ...
            },
            {
                ...
                "render": function(data, type, row) {
                    if (row.is_active == 1) {
                        return '<input name="is_active" type="checkbox" class="is-active-toggle" data-id="' +
                            row.id + '" checked>';
                    } else {
                        return '<input name="is_active" type="checkbox" class="is-active-toggle" data-id="' +
                            row.id + '">';
            ...
            },
            {
                ...
                "render": function(data, type, row) {
                    if (row.is_show_home == 1) {
                        return '<input name="show_home" type="checkbox" class="status-toggle" data-id="' +
                            row.id + '" checked>';
                    } else {
                        return '<input name="show_home" type="checkbox" class="status-toggle" data-id="' +
                            row.id + '">';
    ...
    function resetModal() {
        ...
        var errormsgkategorigaleri = document.getElementById('errormsgkategorigaleri');
        ...
        if (errormsgkategorigaleri) {
            errormsgkategorigaleri.style.display = 'none';
        }
    ...
    document.getElementById('cropBtn').addEventListener('click', function() {
        ...
        if (kategoriCroping.value == '') {
            errormsgkategorigaleri.style.display = 'block';
    ...
    //         this.on("sending", function(file, xhr, formData) {
    //             formData.append("status", $("#galeriUploadForm input[name='status']")
    //                 .val());
    //             formData.append("show_home", $("#galeriUploadForm input[name='show_home']")
    //                 .val());
    //             formData.append("kategori", $("#galeriUploadForm input[name='kategori']")
    //                 .val());
    //         });
