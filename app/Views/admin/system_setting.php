                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="<?= $item['parameter'] ?>"
                                    name="<?= $item['parameter'] ?>" value="<?= $item['nilai']; ?>">
                            </div>
                        </div>
                        <?php
                            endif;
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="dropzone" id="<?= $item['parameter'] ?>-dropzone">
                                            <input type="hidden" name="<?= $item['parameter'] ?>"
                                                id="<?= $item['parameter'] ?>-input" value="<?= $item['nilai']; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="<?= $item['parameter'] ?>"
                                    name="<?= $item['parameter'] ?>" rows="4"><?= $item['nilai']; ?></textarea>
                            </div>
                        </div>
                        <?php else : ?>
                        <input type="hidden" name="id" value="<?= $item['id'] ?>">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="mb-3 flex-end">
                            <button type="submit" class="btn btn-pink" id="saveSystemSettingForm">Perbarui Pengaturan
                                Sistem</button>
                        </div>
                    </div>
                </div>
