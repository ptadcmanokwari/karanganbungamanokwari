    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= csrf_field() ?>
                <div class="mb-3">
                    <div id="errormsgaddnamaproduk" class="alert alert-danger alert-dismissible fade show" role="alert"
                        style="display:none;">
                ...
                <div class="mb-3">
                    <div id="errormsgaddhargaproduk" class="alert alert-danger alert-dismissible fade show" role="alert"
                        style="display:none;">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <div id="errormsgeditnamaproduk" class="alert alert-danger alert-dismissible fade show" role="alert"
                        style="display:none;">
                        <strong>Nama Produk Wajib Diisi</strong>
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                ...
                <div class="mb-3">
                    <div id="errormsgedithargaproduk" class="alert alert-danger alert-dismissible fade show"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="mb-3">
                            <span>Gambar Produk</span>
                            <form action="<?= base_url('admin/update_products') ?>" class="dropzone" id="editProduct">
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-12">
...
$(document).ready(function() {
    ...
    function resetModal() {
        ...
        var errormsgaddnamaproduk = document.getElementById('errormsgaddnamaproduk');
        var errormsgaddhargaproduk = document.getElementById('errormsgaddhargaproduk');
        var errormsgeditnamaproduk = document.getElementById('errormsgeditnamaproduk');
        var errormsgdithargaproduk = document.getElementById('errormsgdithargaproduk');
        ...
        if (errormsgaddnamaproduk) {
            errormsgaddnamaproduk.style.display = 'none';
        }
        if (errormsgaddhargaproduk) {
            errormsgaddhargaproduk.style.display = 'none';
        }
    }
    ...
    document.getElementById('addCropBtn').addEventListener('click', function() {
        ...
        if (nama.value == '' || harga.value == '') {
            if (nama.value == '') {
                errormsgaddnamaproduk.style.display = 'block';
            }
            if (harga.value == '') {
                errormsgaddhargaproduk.style.display = 'block';
            }
        } else {
    ...
    var editDropzone = new Dropzone("#editProduct", {
        ...
        init: function() {
            ...
            this.on("addedfile", function(file) {
                var reader = new FileReader();
                reader.onload = function(event) {
                    var editcropContainer = document.getElementById(
                        'editcropContainer');
                    var editcropImage = document.getElementById('editcropImage');
                    editcropContainer.style.display = 'flex';
                    editcropImage.src = event.target.result;
