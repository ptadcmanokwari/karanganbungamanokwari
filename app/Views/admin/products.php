                                    ...
                                    <tr style="text-align:center;">
                                        ...
                                        <td>
                                            <div class="zoom-container">
                                                <a href="<?= base_url('uploads/products/' . $category['gambar']) ?>" data-gallery="portfolio-gallery-app" class="glightbox preview-link">
                                                    <img class="w-100 zoom-in img-thumbnail" src="<?= base_url('uploads/products/' . $category['gambar']) ?>" alt="Kategori Image">
                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <input name="isPopular" type="checkbox" class="isPopular-toggle" data-id="<?= $category['id'] ?>" <?= $category['is_popular'] ? 'checked' : '' ?>>
                                        </td>
                                        <td>
                                            <button class="btn btn-ubah btn-sm text-white edit-product" data-id="<?= $category['id'] ?>" data-nama="<?= esc($category['nama']) ?>" data-gambar="<?= esc($category['gambar']) ?>" data-harga="<?= esc($category['harga']) ?>">Ubah</button>
                                            <button class="btn btn-secondary btn-sm delete-product" data-id="<?= $category['id'] ?>">Hapus</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
