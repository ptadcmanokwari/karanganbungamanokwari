                            ...
                            <tbody>
                                <?php foreach ($categories as $index => $category) : ?>
                                    <tr style="text-align:center;">
                                        ...
                                        <td>
                                            <button class="btn btn-primary btn-sm text-white edit-product" data-id="<?= $category['id'] ?>" data-nama="<?= esc($category['nama']) ?>" data-gambar="<?= esc($category['gambar']) ?>" data-harga="<?= esc($category['harga']) ?>">Ubah</button>
                                            <button class="btn btn-danger btn-sm delete-product" data-id="<?= $category['id'] ?>">Hapus</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
