                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <a href="<?= base_url(); ?>section_welcome/UcapanSelamat.jpg" data-gallery="portfolio-gallery-app" class="glightbox preview-link">
                                    <img src="<?= base_url(); ?>section_welcome/UcapanSelamat.jpg" class="testimonial-img zoom-in" alt="Karangan Bunga Manokwari Ucapan Selamat dan
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <a href="<?= base_url(); ?>section_welcome/UcapanDuka.jpg" data-gallery="portfolio-gallery-app" class="glightbox preview-link">
                                    <img src="<?= base_url(); ?>section_welcome/UcapanDuka.jpg" class="testimonial-img" alt="Karangan Bunga Manokwari Ucapan Duka Cita, Bela Sungkawa, Turut Berduka Cita, Turut Berbela Sungkawa">
                                </a>
                                <!-- <h3>Saul Goodman</h3>
                                <h4>Ceo &amp; Founder</h4> -->
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <a href="<?= base_url(); ?>section_welcome/UcapanHUT.jpg" data-gallery="portfolio-gallery-app" class="glightbox preview-link">
                                    <img src="<?= base_url(); ?>section_welcome/UcapanHUT.jpg" class="testimonial-img" alt="Karangan Bunga Manokwari Ucapan Selamat Hari Ulang Tahun, Dirgahayu, Selamat Hari Jadi, Anniversary">
                                </a>
                                <!-- <h3>Saul Goodman</h3>
                                 <h4>Ceo &amp; Founder</h4> -->
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <a href="<?= base_url(); ?>section_welcome/UcapanLaunching.jpg" data-gallery="portfolio-gallery-app" class="glightbox preview-link">
                                    <img src="<?= base_url(); ?>section_welcome/UcapanLaunching.jpg" class="testimonial-img" alt="Karangan Bunga Manokwari Ucapan Selamat atas Peresmian suatu Kantor, Launching Bisnis, Pendirian Usaha,">
                                </a>
                                <!-- <h3>Saul Goodman</h3>
                                 <h4>Ceo &amp; Founder</h4> -->
                            </div>
            ...
            <div class="container">
                <div class="row gy-4 mb-5">
                    ...
                    foreach ($produk as $listproduk) { ?>
                        <div class="portfolio-content col-lg-3 col-md-6 service-item d-flex flex-column px-3" data-aos="fade-right" data-aos-delay="100">
                            <a href="<?= base_url(); ?>uploads/products/<?= $listproduk['gambar']; ?>" data-gallery="portfolio-gallery-app" class="glightbox preview-link">
                                ...
                                <?php endif; ?>
                                <img src="<?= base_url(); ?>uploads/products/<?= $listproduk['gambar']; ?>" class="w-100 h-100 img-fluid" alt="<?= $listproduk['nama']; ?>" style="height: 200px !important; object-fit: cover !important;">
                            </a>
                            <div>
                            ...
                            <a id="btnOrder" href="https://api.whatsapp.com/send?phone=<?= $whatsapp; ?>&text=Halo%20Karangan%20Bunga%20Manokwari%0A%0ASaya%20mau%20order%20Papan%20Bunga%20<?= $listproduk['nama']; ?>%0A%0ATerima%20Kasih." target="_blank" class="btn btn-success btnOrder" style="background-color: #25D366; border-color: #25D366; color: white;">
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-<?= $listgalerix; ?>">
                                <div class="portfolio-content h-100">
                                    <a href="<?= base_url(); ?>uploads/gallery/<?= $listgaleri['img']; ?>" data-gallery="portfolio-gallery-app" class="glightbox preview-link">
                                        <img src="<?= base_url(); ?>uploads/gallery/<?= $listgaleri['img']; ?>" class="img-fluid" alt="">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    <a href="<?= base_url('uploads/testimonials/' . $testi['gambar']) ?>" data-gallery="portfolio-gallery-app" class="glightbox preview-link">
                                        <img src="<?= base_url('uploads/testimonials/' . $testi['gambar']) ?>" class="testimonial-img zoom-in" alt="Testimonial Image">
                                    </a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="info-wrap">
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="info-item d-flex mb-2" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <div class="col-lg-3">
                                    <div class="info-item d-flex mb-2" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="col-lg-3">
                                    <div class="info-item d-flex mb-2" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="info-item d-flex mb-0" data-aos="fade-up" data-aos-delay="300">
                                        <i class="bi bi-geo-alt flex-shrink-0"></i>
                                        <div>
                                            <h3>Alamat Toko Cabang</h3>
                                            <p><?= $alamat2; ?></p><br>
